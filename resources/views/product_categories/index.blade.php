...
<div class="w-full py-4">
    <div class="relative overflow-x-auto border bg-gray-200 shadow-md sm:rounded-lg">
        ...
        <table id="product-category-table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
