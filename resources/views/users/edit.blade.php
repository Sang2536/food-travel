<div class="px-4">
    ...
    {{-- <form class="mx-4 space-y-4 md:space-y-6" action="{{ route('user.update', $user->uid) }}" method="POST"> --}}
        @csrf
        <div>
        ...
        <button type="submit" id="btn-user-update" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update user</button>
    {{-- </form> --}}
    {!! Form::close() !!}
</div>
