<div class="pb-4 mx-16">
    <div class="grid grid-cols-2 divide-x-2">
        ...
        <div class="w-full my-4">
            <button type="button" id="create-log-account" data-url="{{ route('account.create-log', ['account' => $account->acc_id]) }}" class="flex float-right items-center justify-center w-28 h-8 p-2 me-1 text-sm font-medium text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            ...
            <button type="button" id="clear-log-account" data-url="{{ route('account.clear-log', ['account' => $account->acc_id]) }}" class="flex float-right items-center justify-center w-28 h-8 p-2 me-1 text-sm font-medium text-white rounded-lg bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                <div role="status-start" class="flex text-center">
    ...
    <div id="table-logs" class="w-full my-4">
        @if ($account->logs)
            ...
            <div class="w-full mt-8 text-end">
                <!-- Modal toggle -->
                <a href="#" type="button" data-modal-target="table-logs-modal" data-modal-toggle="table-logs-modal" class="font-medium px-2 text-cyan-600 dark:text-cyan-500 hover:underline">
                    Detail
                </a>
            </div>
                ...
                <div class="relative w-full max-w-lg max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="table-logs-modal">
