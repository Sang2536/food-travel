<div class="flex-initial w-full">
    ...
    <aside id="multi-level-sidebar" class="fixed top-0 left-0 z-40 max-w h-screen mt-20 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
