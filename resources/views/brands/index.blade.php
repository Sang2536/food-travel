...
<div class="text-center">
    <div class="relative overflow-x-auto border shadow-md sm:rounded-lg">
        <div class="my-8 mx-2 flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 dark:bg-gray-900">
            <div class="relative">
        ...
        <table id="brand-table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
...
<div id="brand-modal" tabindex="-1" aria-hidden="true"  aria-labelledby="brand-title-modal" class="hidden overflow-y-auto overflow-x-hidden fixed left-1/2 top-1/2 z-50 object-center justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
</div>
@endsection
